...
<head>
    ...
    <style>
        :root { --dark: #0f1115; --card: #1c1f26; --accent: #ffc107; }
        ...
        .card:hover { transform: translateY(-8px); box-shadow: 0 10px 20px rgba(0,0,0,0.5); }

        .img-box { height: 220px; overflow: hidden; position: relative; background: #000; }
        .card-img-top { width: 100%; height: 100%; object-fit: cover; }

        .btn-warning { font-weight: 700; border-radius: 10px; padding: 8px 24px; text-transform: uppercase; }
        .main-title { font-weight: 800; text-transform: uppercase; letter-spacing: 2px; margin: 50px 0; text-align: center; }
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white-50" href="#" data-bs-toggle="dropdown">Khám phá Menu</a>
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <c:forEach var="loai" items="${loaiList}">
                            <li><a class="dropdown-item" href="${ctx}/home?maLoai=${loai.maLoai}">${loai.tenLoai}</a></li>
                        </c:forEach>
...
<div class="container my-5">
    <h1 class="main-title">Menu <span>Đặc Sắc</span></h1>
